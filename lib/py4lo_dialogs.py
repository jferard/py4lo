...
class ProgressExecutorBuilder:
    ...
    def build(self):
        ...
        _set_rectangle(self._oText, Rectangle(MARGIN, y, w, h))
...
class ConsoleExecutorBuilder:
    def __init__(self):
        ...
        self._oText.ReadOnly = True
        self._oText.MultiLine = True
        self._oText.VScroll = True
    ...
    def build(self):
        ...
        _set_rectangle(self._oText, Rectangle(MARGIN, MARGIN,
                                              self._console_rectangle.w - MARGIN * 2,
                                              self._console_rectangle.h - MARGIN * 2))
        return ConsoleExecutor(self._oDialog, self._oText)


class ConsoleHandler:
    def __init__(self, oText):
        self._oText = oText
        self._cur_text = oText.Text
        self.response = None
    ...
    def message(self, text):
        ...
        self._oText.Text = self._cur_text


class ConsoleExecutor:
    def __init__(self, oDialog, oText):
        self._oDialog = oDialog
